...
@Component
public class SuitRoomBookingMapper {
  public SuitRoomBookingEntity SuitRoomBookingENTITY(RoomBookingDTO roomBookingDTO){
      SuitRoomBookingEntity entity=new SuitRoomBookingEntity();
  ...
  public RoomBookingDTO SuitRoomBookingDTO(SuitRoomBookingEntity entity){
